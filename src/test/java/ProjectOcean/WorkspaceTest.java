...
public class WorkspaceTest {
    ...
    public void createCourses() {
        ...
        ICourse course2 = CourseFactory.CreateCourse("CAT123","Complex system", "7.5", "2","Anders Frölinge", "Tenta", "Svenska", new ArrayList<>(), "www.google.com", "Lorem Ipsum", "IT");

        ICourse course3 = CourseFactory.CreateCourse("DAT321","Datavetenskap", "7.5", "4","Anders Bröninge", "Tenta", "Svenska", new ArrayList<>(), "www.google.com", "Lorem Ipsum", "IT");

        ICourse course4 = CourseFactory.CreateCourse("FAT321","Fysik för ingenjörer", "7.5", "1","Anders Brölinge", "Tenta", "Svenska", new ArrayList<>(), "www.google.com", "Lorem Ipsum", "NA");
    ...
    public void removeCourseTest(){
        ...
        coursesTemp.add(course3);
        coursesTemp.add(course4);
        ICourse courseTemp = CourseFactory.CreateCourse("DAT017","Maskinorienterad programmering", "7.5", "1","Rolf Söderström", "Tenta", "Svenska", new ArrayList<>(), "www.google.com", "Lorem Ipsum", "IT");
